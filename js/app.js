...
<PathOfBuilding2>
	<Build characterLevelAutoMode="true" viewMode="TREE" className="${classInfo.name}" ascendClassName="None" mainSocketGroup="1" targetVersion="0_1" level="90">
	</Build>
	<Items useSecondWeaponSet="nil" showStatDifferences="true" activeItemSet="1">
		<ItemSet id="1" useSecondWeaponSet="nil">
		</ItemSet>
	</Items>
	<Calcs>
	</Calcs>
